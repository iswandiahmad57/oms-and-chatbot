...
app.post('/ai', (req, res) => {
  ...
  let msg="Hallo Ahmad, saya bisa membantu kamu untuk menemukan produk kami ,coba ketikka apa saja, seperti: \n 1. saya mau pesan paper bag. \n 2. saya ingin order undangan. \n 3. cek order saya \n 4. info harga \n 5. saya minta rekomendasi produk";
  ...
  //disini akan disesuaikan jawaban dengan intent yang dikirim
  //misal jika intent greetings maka jawabanny sudah ada di dalam folder intents file greetings.js
...
/*fungsi untuk melakukan pengiriman generic template message berupa produk yang di ambil dari sistem management order
 *
 */
 ...
 *
 */
/*fungsi untuk melakukan pengiriman generic template message berupa invoice
 *
 */
/*fungsi untuk melakukan pengiriman generic template message berupa pemberitahuan proses pengerjaan 
 *fungsi ini akan dieksekusi apabila terdapat triggered dari aplikasi management order
 */
...
function receivedMessage(event) {
  ...
  if (messageText) {
    ...
    switch (messageText) {
      ...
      default:
        const app = nlp("ee4b10fce9a845419f72802b05ac8257");
        var apiai = app.textRequest(messageText, {
            sessionId: 'test_session'
        });
...
function receivedPostback(event) {
  ...
  if(payload==="GET_STARTED_PAYLOAD" || payload==="BANTUAN"){
